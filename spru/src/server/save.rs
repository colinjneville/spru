...
/// A game saved by the [crate::Server] which can be used to create another Server
...
pub struct Save<Server: super::Server> {
    ...
    pub(crate) snapshot: common::Snapshot<<Server::State as tagset::TagSet>::Repr, Server::State, Server::Root>,
