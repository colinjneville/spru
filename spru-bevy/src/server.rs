...
// #[derive(Resource)]
// pub struct BevyServer<State, Action, Root, PlayerInit, Reaction> {
//     server: spru::Server<State, Action, Root, PlayerInit, Reaction>,
// }

// impl<State, Action, Root, PlayerInit, Reaction> BevyServer<State, Action, Root, PlayerInit, Reaction> {
